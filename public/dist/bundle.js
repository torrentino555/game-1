...
class Scoreboard extends __WEBPACK_IMPORTED_MODULE_0__baseview__["a" /* default */] {
    ...
    creation() {
        ...
        this.appendChildBlock('scoreboard', new __WEBPACK_IMPORTED_MODULE_0__baseview__["a" /* default */]('ul', ['scoreboard']));
        for (let i = 0; i < 4; ++i) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__transport_transport__ = __webpack_require__(60);
